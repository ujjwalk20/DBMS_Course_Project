...
class mainComponent extends React.Component {
  ...
  render() {
    if (
      this.state.active == "important" &&
      this.state.important != null &&
      ...
      return (
        ...
        <ImportantNotes
          ...
          importImportant={(important) => {
            this.setState({ important: important, options: null });
          }}
    ...
    else if (this.state.notes != null && this.state.active == "home")
      return (
        <Homepage
